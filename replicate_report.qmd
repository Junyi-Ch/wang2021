...
Data analysis:
 1. Ran preprocessing_multiarrangement.py to get a files that contain the 90 × 90 word matrix for all participants.
 2. Ran data_analysis_multiarrangement.py to perform the planned analysis with 10000 bootstraps. 
